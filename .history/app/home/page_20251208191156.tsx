  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      <main className="relative flex flex-1 items-center justify-center p-4 overflow-hidden">
        ...
        <div className="absolute top-1/2 right-[-15rem] transform -translate-y-1/2 w-[30rem] h-[30rem] rounded-full border-[10px] border-black pointer-events-none z-10 flex items-center justify-center">
            {/* Círculo de preenchimento interno */}
            <div className="w-[calc(100%-20px)] h-[calc(100%-20px)] bg-black rounded-full"></div> 
        </div>
