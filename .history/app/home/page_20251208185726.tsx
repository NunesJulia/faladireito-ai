  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      <main className="relative flex flex-1 items-center justify-center p-4 overflow-hidden">
        ...
        {/* NOVO: Imagem de Fundo (pc.png) - z-0 para ficar atrás de tudo */}
        <div className="absolute inset-0 flex items-center justify-center z-0">
            <Image
                src="/pc.png" // Caminho no diretório public
                alt="Fundo de computador"
                // Ajustar width/height para o Next.js Image component
                width={1200} 
                height={800}
                className="object-cover opacity-10" // Opacidade bem baixa para ser um fundo sutil
            />
        </div>
