...
const CentralPromptBar = ({ handleNavigate }) => {
  return (
    // Adicionado z-10 para garantir que fique acima da sombra
    <div className="z-10 w-[90%] md:w-[80%] lg:w-[40%] max-w-4xl bg-black rounded-xl p-6 shadow-2xl">
      ...
      <div className="flex items-center justify-between space-x-3">
        ...
        <div className="flex space-x-2">
          ...
          <button className="p-3 bg-black hover:bg-gray-700 text-white rounded-full transition duration-150 border border-white">
            <Plus className="w-5 h-5" />
          </button>
          
          {/* Botão Buscar com Stroke Branco */}
          <button className="p-3 bg-black hover:bg-gray-700 text-white rounded-full transition duration-150 flex items-center space-x-1 border border-white">
  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <nav className="flex space-x-2">
            ...
            <button
              ...
              className={`px-5 py-3 bg-black text-white hover:bg-gray-800 rounded-full transition duration-150 flex items-center text-sm`}
            >
              Login
            </button>
            ...
            <button
              ...
              // Aplica borda preta (border-black), fundo branco (bg-white) e bordas arredondadas (rounded-full)
              className={`px-5 py-3 bg-white border border-black text-black hover:bg-gray-100 rounded-full transition duration-150 flex items-center text-sm`}
            >
              Prompt
            </button>
          </nav>
      ...
      <main className="relative flex flex-1 items-center justify-center p-4 overflow-hidden">
        ...
        {/* NOVO: Sombra Circular Preta na Extrema Direita */}
        <div className="absolute top-1/2 right-0 transform -translate-y-1/2 w-[30rem] h-[30rem] bg-black rounded-full filter blur-3xl opacity-20 pointer-events-none z-0"></div>
