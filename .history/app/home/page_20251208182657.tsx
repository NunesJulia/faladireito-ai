        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <nav className="flex space-x-2">
            ...
            <button
              ...
              className={`px-4 py-2 bg-black text-white hover:bg-gray-800 rounded-full transition duration-150 flex items-center text-sm`}
            >
              Login
            </button>
            ...
            <button
              ...
              className={`px-4 py-2 bg-white border border-black text-black hover:bg-gray-100 rounded-full transition duration-150 flex items-center text-sm`}
            >
              Prompt
            </button>
          </nav>
