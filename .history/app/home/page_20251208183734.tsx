  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      <main className="relative flex flex-1 items-center justify-center p-4 overflow-hidden">
        ...
        <div className="absolute top-1/2 right-[-15rem] transform -translate-y-1/2 w-[30rem] h-[30rem] bg-black rounded-full filter blur-xl opacity-8 pointer-events-none z-0"></div>
